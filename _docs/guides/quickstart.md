...
*   [`EnterAndRun`]({{home}}/doxygen/classasylo_1_1EnclaveClient.html#enter-and-run): This method takes an `EnclaveInput` message, passes it to the
...
*   [`Initialize`]({{home}}/doxygen/classasylo_1_1TrustedApplication.html#initialize): This method takes an `EnclaveConfig` message from
    `EnclaveClient::EnterAndInitialize`, and initializes the enclave with the
    configuration settings in the `EnclaveConfig`.
*   [`Run`]({{home}}/doxygen/classasylo_1_1TrustedApplication.html#run): This method takes an `EnclaveInput` message from
    `EnclaveClient::EnterAndRun`, populates an `EnclaveOutput` message, and
    performs trusted execution.
*   [`Finalize`]({{home}}/doxygen/classasylo_1_1TrustedApplication.html#finalize): This method takes an `EnclaveFinal` message from
